...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ asset('adminlte/index3.html') }}" class="brand-link text-center">
                {{-- <img src="{{ asset('asset/images/logo_1.png') }}" alt=""> --}}
                <span class="brand-text font-weight-light" style="font-weight: bold !important">Evertec Shop</span>
            </a>
